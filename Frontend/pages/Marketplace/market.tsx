  ...
  return (
    <div className={styles.marketCtn}>
      ...
      <div className={styles.marketJumboCtn}>
        <div>
        <p className={styles.marketText}>Collect The Awesome Extaordinary NFTs</p>
        <p className={styles.belowMarketText}>Digital marketplace for crypto collectibles and non-fungible tokens, NFTs</p>
      ...
      <div className={styles.belowJumboCtn}>
        <div className={styles.statsCtn}>
            ...
            <div>
              <p>Floor Price</p>
              <p>
                <span className={styles.coinIconCtn}><Image src={Coin} /></span>
                200
              </p>
            </div>
            <div>
